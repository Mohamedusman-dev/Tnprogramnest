...
const Training = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-foreground overflow-x-hidden font-sans">
      ...
      {/* 8. Call to Action (Using ContactSection) */}
      <div className="bg-slate-50 pt-10 pb-4 text-center px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 font-display">Partner With Us for Training</h2>
        <p className="text-slate-600 max-w-2xl mx-auto text-lg">
          Looking to organize a tech session for your students? Let’s plan a practical and engaging program for your institution.
        </p>
      </div>
      
      {/* Reusing the Contact Section for the CTA */}
      <ContactSection />
