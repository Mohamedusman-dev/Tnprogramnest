...
import { 
  ArrowRight, Rocket, Users, Award, Lightbulb, Globe, 
  PenTool, Settings, Clock, ShieldCheck, PhoneCall, 
  Cpu, TrendingUp, Search, Megaphone, Mail, Share2, BarChart
} from "lucide-react";
...
const workflowData = [
  { icon: Search, title: "Market Research", desc: "We analyze your industry, competitors, and target audience to identify the most profitable marketing channels." },
  { icon: Lightbulb, title: "Strategy Formulation", desc: "Developing a customized, multi-channel marketing plan aligned with your specific business objectives and budget." },
  { icon: Megaphone, title: "Campaign Execution", desc: "Launching targeted ads, publishing SEO content, and managing social media profiles to engage your audience." },
  { icon: BarChart, title: "Monitoring & Analytics", desc: "Tracking campaign performance in real-time using advanced analytics tools to measure ROI and engagement." },
  { icon: TrendingUp, title: "Optimization", desc: "Continuously refining ad copy, targeting, and SEO strategies based on data to maximize your return on investment." }
];
      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-[#0a0a0a] text-white overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?q=80&w=2074&auto=format&fit=crop')] bg-cover bg-center opacity-10 mix-blend-overlay"></div>
          </div>
          <div className="container mx-auto px-4 relative z-10 text-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
                Data-driven marketing strategies to increase brand visibility, drive targeted traffic, and maximize your conversions.
              </p>
        ...
        <section className="py-12 md:py-16 bg-white border-y border-slate-100">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: Search, title: "SEO Optimization", desc: "Rank higher on Google and drive organic, high-intent traffic." },
                { icon: Share2, title: "Social Media", desc: "Engage your audience on Facebook, Instagram, and LinkedIn." },
                { icon: Megaphone, title: "PPC Advertising", desc: "High-ROI campaigns on Google Ads and social platforms." },
                { icon: PenTool, title: "Content Marketing", desc: "Valuable blogs, videos, and graphics that build authority." },
                { icon: Mail, title: "Email Marketing", desc: "Automated sequences to nurture leads and retain customers." },
                { icon: TrendingUp, title: "CRO", desc: "Conversion Rate Optimization to turn more visitors into buyers." },
                { icon: BarChart, title: "Analytics & Reporting", desc: "Transparent, data-driven insights into your campaign performance." },
                { icon: Globe, title: "Brand Strategy", desc: "Positioning your brand effectively in the digital landscape." },
              ].map((item, i) => (
        ...
        <section className="py-12 md:py-16 bg-slate-50 border-b border-slate-100">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-12 md:mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 font-display">Marketing Stack</h2>
        ...
        <section className="py-12 md:py-16 bg-white relative overflow-hidden">
          <div className="container mx-auto px-4 max-w-6xl relative z-10">
            <div className="mb-12 md:mb-16 text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 font-display tracking-tight">Marketing Workflow</h2>
              <div className="w-16 h-1 bg-primary mx-auto rounded-full"></div>
            </div>
          ...
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              <AccordionItem value="item-1" className="bg-white border border-slate-200 rounded-lg px-4">
                <AccordionTrigger className="text-left font-semibold text-slate-900 hover:no-underline hover:text-primary">How long does it take to see SEO results?</AccordionTrigger>
                <AccordionContent className="text-slate-600 leading-relaxed">SEO is a long-term strategy. Typically, you will start seeing noticeable improvements in rankings and traffic within 3 to 6 months, depending on the competitiveness of your industry.</AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2" className="bg-white border border-slate-200 rounded-lg px-4">
                <AccordionTrigger className="text-left font-semibold text-slate-900 hover:no-underline hover:text-primary">PPC vs. SEO: Which is better?</AccordionTrigger>
                <AccordionContent className="text-slate-600 leading-relaxed">PPC provides immediate traffic and leads, while SEO builds sustainable, long-term organic traffic. We usually recommend a combined approach for the best ROI.</AccordionContent>
              </AccordionItem>
        ...
        <section className="py-10 md:py-12 bg-primary relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-6 font-display">Ready to grow your brand?</motion.h2>
            <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="text-blue-100 text-base md:text-lg mb-8 max-w-2xl mx-auto">Let's build a data-driven marketing strategy that delivers real results.</motion.p>
