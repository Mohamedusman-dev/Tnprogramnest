...
import { 
  ...
  TestTube, Layers, LayoutDashboard, Server
} from "lucide-react";
...
const workflowData = [
  { icon: Lightbulb, title: "Ideation & Strategy", desc: "We collaborate to define the product vision, target audience, and core value proposition." },
  { icon: PenTool, title: "Prototyping", desc: "Creating wireframes and interactive prototypes to visualize the product and gather early feedback." },
  { icon: Layers, title: "MVP Development", desc: "Building a Minimum Viable Product with essential features to test the market quickly." },
  { icon: TestTube, title: "Testing & Feedback", desc: "Rigorous QA testing and gathering user feedback to refine and improve the product." },
  { icon: Rocket, title: "Launch & Scale", desc: "Deploying the product and continuously adding features to scale the user base." }
];
      ...
      <main>
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
                End-to-end product development from ideation and prototyping to full-scale engineering, launch, and iterative scaling.
              </p>
        ...
        <section className="py-12 md:py-16 bg-white border-y border-slate-100">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: Lightbulb, title: "Product Strategy", desc: "Market research and feature prioritization." },
                { icon: PenTool, title: "UI/UX Prototyping", desc: "Interactive wireframes and user journey mapping." },
                { icon: Layers, title: "MVP Development", desc: "Fast time-to-market with core functionalities." },
                { icon: Code, title: "Full-Scale Engineering", desc: "Robust frontend and backend architecture." },
                { icon: ShieldCheck, title: "Quality Assurance", desc: "Automated and manual testing for reliability." },
                { icon: Server, title: "Cloud Infrastructure", desc: "Scalable hosting setup on AWS or Google Cloud." },
                { icon: Rocket, title: "Product Launch", desc: "Smooth deployment and App Store submissions." },
                { icon: LayoutDashboard, title: "Iterative Scaling", desc: "Data-driven updates and feature enhancements." },
              ].map((item, i) => (
        ...
        <section className="py-12 md:py-16 bg-white relative overflow-hidden">
          <div className="container mx-auto px-4 max-w-6xl relative z-10">
            <div className="mb-12 md:mb-16 text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 font-display tracking-tight">Product Lifecycle</h2>
              <div className="w-16 h-1 bg-primary mx-auto rounded-full"></div>
            </div>
          ...
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              <AccordionItem value="item-1" className="bg-white border border-slate-200 rounded-lg px-4">
                <AccordionTrigger className="text-left font-semibold text-slate-900 hover:no-underline hover:text-primary">What is an MVP?</AccordionTrigger>
                <AccordionContent className="text-slate-600 leading-relaxed">A Minimum Viable Product (MVP) is the first version of your product with just enough features to satisfy early customers and provide feedback for future development.</AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2" className="bg-white border border-slate-200 rounded-lg px-4">
                <AccordionTrigger className="text-left font-semibold text-slate-900 hover:no-underline hover:text-primary">Do you follow Agile methodology?</AccordionTrigger>
                <AccordionContent className="text-slate-600 leading-relaxed">Yes, we use Agile/Scrum methodologies. This means we work in sprints, allowing for flexibility, regular updates, and continuous feedback throughout the development cycle.</AccordionContent>
              </AccordionItem>
        ...
        <section className="py-10 md:py-12 bg-primary relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-6 font-display">Ready to build your product?</motion.h2>
            <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="text-blue-100 text-base md:text-lg mb-8 max-w-2xl mx-auto">Let's turn your vision into a market-ready digital product.</motion.p>
