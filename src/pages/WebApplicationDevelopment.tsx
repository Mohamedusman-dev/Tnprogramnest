...
const workflowData = [
  { icon: Lightbulb, title: "Requirement Analysis", desc: "We deeply analyze your business processes to define the architecture and feature set of your web application." },
  { icon: Layout, title: "Prototyping & Design", desc: "Creating wireframes and interactive prototypes to visualize the user flow and ensure an intuitive user experience." },
  { icon: Code, title: "Development", desc: "Building the frontend and backend using modern frameworks, ensuring the code is scalable, secure, and maintainable." },
  { icon: ShieldCheck, title: "Testing & QA", desc: "Comprehensive testing including unit, integration, and security testing to ensure a flawless application." },
  { icon: Rocket, title: "Deployment", desc: "Deploying the application to cloud infrastructure (AWS, Vercel) and setting up CI/CD pipelines for future updates." }
];
      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-[#0a0a0a] text-white overflow-hidden">
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1461749280684-dccba630e2f6?q=80&w=2069&auto=format&fit=crop')] bg-cover bg-center opacity-10 mix-blend-overlay"></div>
          </div>
          <div className="container mx-auto px-4 relative z-10 text-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="max-w-4xl mx-auto">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight font-display">
                Web Application <br className="hidden md:block" />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-primary">Development</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
                Custom, scalable, and secure web applications tailored to streamline your business operations and engage your users.
              </p>
        ...
        <section className="py-12 md:py-16 bg-white border-y border-slate-100">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: Globe, title: "Custom Web Apps", desc: "Tailor-made solutions built from scratch to fit your exact needs." },
                { icon: MonitorSmartphone, title: "PWA Development", desc: "Progressive Web Apps that work offline and feel like native apps." },
                { icon: Server, title: "Enterprise Solutions", desc: "Scalable architectures designed for large organizations." },
                { icon: Cloud, title: "Cloud Integration", desc: "Seamless deployment and scaling on AWS, Azure, or GCP." },
                { icon: PenTool, title: "UI/UX Design", desc: "Intuitive and modern interfaces that users love." },
                { icon: Code, title: "API Development", desc: "Robust REST and GraphQL APIs for seamless connectivity." },
                { icon: ShieldCheck, title: "Security Audits", desc: "Ensuring your app is protected against modern web threats." },
                { icon: Wrench, title: "Support & Maintenance", desc: "Ongoing updates to keep your application running smoothly." },
              ].map((item, i) => (
          ...
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              <AccordionItem value="item-1" className="bg-white border border-slate-200 rounded-lg px-4">
                <AccordionTrigger className="text-left font-semibold text-slate-900 hover:no-underline hover:text-primary">Difference between a website and a web app?</AccordionTrigger>
                <AccordionContent className="text-slate-600 leading-relaxed">A website is primarily informational (like a brochure), while a web app is interactive and allows users to perform actions (like a CRM, dashboard, or social network).</AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2" className="bg-white border border-slate-200 rounded-lg px-4">
                <AccordionTrigger className="text-left font-semibold text-slate-900 hover:no-underline hover:text-primary">Will my web app be scalable?</AccordionTrigger>
                <AccordionContent className="text-slate-600 leading-relaxed">Yes, we build using modern, scalable architectures (like microservices) and deploy on robust cloud platforms (AWS, GCP) to ensure your app grows with your business.</AccordionContent>
              </AccordionItem>
        ...
        <section className="py-10 md:py-12 bg-primary relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-6 font-display">Ready to build your web app?</motion.h2>
            <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="text-blue-100 text-base md:text-lg mb-8 max-w-2xl mx-auto">Let's turn your idea into a scalable, high-performance reality.</motion.p>
